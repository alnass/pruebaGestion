              ...
              <li class="dropdown notifications-menu">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  <i class="fa fa-bell-o" id='contador'> 
                    <!-- <p  class="label label-success" id="notif_cantidad">
                ...
                echo '
                  <li class="treeview">
                    ...
                    <ul class="treeview-menu">
                      ...
                      <li>
                        <a href="consultaEfectivoHoy.php"><i class="fa fa-circle-o"></i>Efectivo caja</a>
                      </li> 
                      <li>
                        <a href="../reportes/exEfectivoSedes.php" target="_blanck"><i class="fa fa-circle-o"></i>Efectivo en Sedes</a>
                      </li> 
                      <li>
                        <a href="apertura.php" target="_blanck"><i class="fa fa-circle-o"></i>Apertura de sede</a>
                      </li>                
                    </ul>
                  </li>
                ';  
