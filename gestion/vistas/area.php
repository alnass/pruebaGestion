        ...
        <div class="col-md-12">
          <div class="box">
            <div class="box-header with-border">
                  <h1 class="box-title">Área <br><br><button class="btn btn-success" id="btnAgregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
            ...
            <div class="panel-body " style="height: auto;" id="formularioregistro">
                <form name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                    ...
                    <input type="hidden"  name="are_id" id="are_id">
                    <input type="text" class="form-control" name="nombre" id="nombre" maxlength="45" placeholder="Área" required="">
                  </div>
                  ...
                  <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                    ...
                    <input type="text" class="form-control" name="correo" id="correo" maxlength="512" placeholder="Correo electronico">
                  </div>
