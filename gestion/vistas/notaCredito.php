      ...
      <div class="content-wrapper">
        ...
        <section class="content">
            <div class="row">
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border" style="background: #81F781;">
                          <h1 class="">Registro de 'NOTAS CREDITO'<br></h1>
                          <p>Las notas credito representan un descuento en saldo actual del suscriptor</p>
                      ...
                      <div class="row">  
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-3 col-md-3 col-sm-6 col-xs-12">
                            ...
                            <textarea class="form-control" name="observacion" id="observacion" cols="30" rows="4" style="resize: none;" placeholder="Escriba aqui las observaciones correspondientes a la transacción" required=""></textarea>                                   
                          </div>
