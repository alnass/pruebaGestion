...
function listar()
{
		...
		tabla=$('#tbllistado').dataTable({
			...
			buttons: [
				...
				'csvHtml5',
				{
		            ...
		            title: 'Reporte de Recaudo General:: Sistema GlobalPlay.'
		        }
			],
			"ajax":{
				url:'../ajax/consolidadoVentas.php?op=listar',
				type: "get",
				dataType: "json",
				error: function(e){
	...
	else if(producto == 2)
	{
		...
		tabla=$('#tbllistado').dataTable({
			...
			buttons: [
			{
		        ...
		        text: 'PDF',
		        orientation: 'landscape',
		        title: 'Reporte de Recaudo Internet:: Sistema GlobalPlay.'
		    },
				'excelHtml5',
				'csvHtml5'
			],
			"ajax":{
				url:'../ajax/consolidadoVentas.php?op=listar-int',
				type: "get",
				dataType: "json",
				error: function(e){
					console.log(e.responseText);
		...
		tabla=$('#tbllistado').dataTable({
			...
			buttons: [
				...
				'csvHtml5',
				{
			        ...
			        text: 'PDF',
			        orientation: 'landscape',
			        title: 'Reporte de Recaudo Television Analoga:: Sistema GlobalPlay.'
			    }
			],
			"ajax":{
				url:'../ajax/consolidadoVentas.php?op=listar-tva',
				type: "get",
				dataType: "json",
				error: function(e){
					console.log(e.responseText);
		...
		tabla=$('#tbllistado').dataTable({
			...
			buttons: [
				...
				'csvHtml5',
				{
			        ...
			        text: 'PDF',
			        orientation: 'landscape',
			        title: 'Reporte de Recaudo Television Digital:: Sistema GlobalPlay.'
			    }
			],
			"ajax":{
				url:'../ajax/consolidadoVentas.php?op=listar-tvd',
				type: "get",
				dataType: "json",
				error: function(e){
					console.log(e.responseText);
	...
	else if(producto == 5)
	{
		...
		tabla=$('#tbllistado').dataTable({
			...
			"ajax":{
				url:'../ajax/consolidadoVentas.php?op=listar-otros',
				type: "get",
				dataType: "json",
				error: function(e){
					console.log(e.responseText);
