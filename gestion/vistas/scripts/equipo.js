...
function mostrar(equi_id){
	$.post("../ajax/equipo.php?op=mostrar",{equi_id : equi_id}, function(data, status)
	{
...
function desactivar(equi_id){
	bootbox.confirm("¿Esta seguro de desactivar este equipo?",function(result){
		if (result) {
...
function detalle(equi_id){
	...
	tabla=$('#equipoDetalle').dataTable({
		...
		"ajax":{
			url:'../ajax/equipo.php?op=detalle',
			type: "post",
			data: {equi_id},
			dataType: "json",
			error: function(e){
