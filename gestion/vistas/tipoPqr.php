              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">Tipo de PQR's <br><br><button class="btn btn-success" id="btnAgregar" onclick="mostrarform(true)"><i class="fa fa-plus-circle"></i> Agregar</button></h1>
                    ...
                    <div class="panel-body " style="height: 400px;" id="formularioregistro">
                        ...
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12" >
                            <label for="nombre">Tipo de PQR's:</label>
                            <input type="hidden"  name="tip_pqr_id" id="tip_pqr_id">
                            <input type="text" class="form-control" name="nombre" id="nombre" maxlength="45" placeholder="Tipo de PQR's" required="">
                          </div>
...
// Redireccionamiento a por validacion de permisos
 ...
 require 'footer.php'
?>
 <script type="text/javascript" src="scripts/tipoPqr.js"></script>  
<?php 
}
