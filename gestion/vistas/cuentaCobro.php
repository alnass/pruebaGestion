        ...
        <div class="box">
          <div class="box-header with-border" style="background: #A9D0F5;">
            <h1 class="">
              ...
              Listado para impresión de cuentas de cobro<br><br>
            </h1>
          ...
          <div class="panel-body table-responsive" id="listadoregistros"><!-- centro -->
            <div class="col-md-3" style="padding-top: 3px;">
              <label for="sede">Seleccione una sede <i class="fa fa-arrow-right"></i> </label>
            </div>
            <div class="col-md-3">
              <div class="form-group">
                <select class="form-control selectpicker" id="sede"></select>
              </div>
            </div>
            <div class="col-md-3">
              <button class="btn btn-success" id="masivo">Generar Masivo</button>
            </div>
